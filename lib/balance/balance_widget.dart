            ...
            children: [
              Text(
                valueOrDefault<String>(
                  FFAppState().userBalance.toString(),
                  '0',
                ),
                  ...
                  onTap: () async {
                    var confirmDialogResponse = await showDialog<bool>(
                          ...
                          builder: (alertDialogContext) {
                            return AlertDialog(
                              title: Text('Телефондун балансына акча жөнөтүү'),
                              content: Text(
                                  'Туура телфон номеринизди киргизип, биз бир жуманын ичинде акчанызды жөнөтөбүз'),
                              actions: [
                                TextButton(
                                  onPressed: () =>
